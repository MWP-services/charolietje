...
export const buildSeedMeals = (userId: string): MealWithItems[] => [
  ...
  buildMeal(userId, 0, 'lunch', 'For lunch I had a chicken sandwich and an apple.', [
  ...
  buildMeal(userId, 0, 'dinner', 'Dinner was salmon with rice and vegetables.', [
  ...
  buildMeal(userId, 0, 'snack', 'I had a protein yogurt as a snack.', [
    { name: 'protein yogurt', quantity: 200, unit: 'gram', calories: 148, protein: 20, carbs: 9, fat: 2.5, fiber: 0, sugar: 8, sodium: 82 },
  ]),
  buildMeal(userId, 1, 'breakfast', 'Breakfast was oats with banana and milk.', [
  ...
  buildMeal(userId, 2, 'dinner', 'Dinner was chicken pasta with olive oil and vegetables.', [
